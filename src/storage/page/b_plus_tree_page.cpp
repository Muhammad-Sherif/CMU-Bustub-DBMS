 ...
 */
bool BPlusTreePage::IsLeafPage() const { return page_type_ == IndexPageType::INTERNAL_PAGE; }
bool BPlusTreePage::IsRootPage() const { return parent_page_id_ == IndexPageType::INVALID_INDEX_PAGE; }
